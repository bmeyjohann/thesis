...
def maybe_wrap_intervention(
    ...
    *,
    ...
    tolerance_xyz_value: float,
    tolerance_yaw_value: float,
    tolerance_gripper_value: float,
    tolerance_adaptive_enable: bool,
    tolerance_adaptive_near_distance: float,
    tolerance_adaptive_far_distance: float,
    tolerance_adaptive_near_scale: float,
