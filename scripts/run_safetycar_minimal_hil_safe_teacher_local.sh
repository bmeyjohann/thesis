...
SAFE_TEACHER_CKPT="${SAFE_TEACHER_CKPT:-/home/benjamin/thesis/models/safetygym_minimal/safetycar_min_safe_dense_cost001_step_big_noviz_20260402_200356/step_5000.pt}"
TIMESTAMP="${TIMESTAMP:-$(date +%Y%m%d_%H%M%S)}"
NET_TAG="${NET_TAG:-big}"
TEACHER_TAG="${TEACHER_TAG:-safe_teacher_clear008}"
TOTAL_TIMESTEPS="${TOTAL_TIMESTEPS:-20000}"
CHECKPOINT_INTERVAL="${CHECKPOINT_INTERVAL:-5000}"

EXP_PREFIX="${EXP_PREFIX:-safetycar_min_hil_safe_teacher_${NET_TAG}_${TEACHER_TAG}}"
...
/home/benjamin/thesis/scripts/run_safetycar_minimal_human_ready_local.sh \
  ...
  EXPERT_CHECKPOINT_PATH="$SAFE_TEACHER_CKPT" \
