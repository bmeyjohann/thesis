...
WANDB_RUN_NAME="${WANDB_RUN_NAME:-${EXPERIMENT_TAG}_pretrain_dense_${TS}}"
...
echo "Starting SafetyCar dense Euclidean pretraining run."
echo "Reward mode: ${REWARD_MODE}"
echo "Collision/object-contact costs remain outside the reward."
echo "Final actor/critic checkpoint will be saved automatically under models/safetygym/."
