...
EXP_NAME="${EXP_NAME:-cube_single_task1_relonly_layernorm_newteacher_utd1_120k_own_disable_rotation_interv_${INTERVENTION_EPISODE_PROB}_${TS}}"
...
echo "Disable rotation: ON"
echo "Deviation thresholds: xyz=${TOL_XYZ}, yaw=${TOL_YAW}, gripper=${TOL_GRIPPER}"
