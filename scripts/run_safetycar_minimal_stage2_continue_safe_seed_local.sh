...
SAFE_SEED_CKPT="${SAFE_SEED_CKPT:-/home/benjamin/thesis/models/safetygym_minimal/safetycar_min_safe_dense_cost001_step_big_noviz_20260402_200356/step_5000.pt}"
TIMESTAMP="${TIMESTAMP:-$(date +%Y%m%d_%H%M%S)}"
NET_TAG="${NET_TAG:-big}"
SEED_TAG="${SEED_TAG:-cost001_step_seed005k}"
TOTAL_TIMESTEPS="${TOTAL_TIMESTEPS:-50000}"
CHECKPOINT_INTERVAL="${CHECKPOINT_INTERVAL:-5000}"

EXP_PREFIX="${EXP_PREFIX:-safetycar_min_stage2_continue_safe_seed_${NET_TAG}_${SEED_TAG}}"
...
/home/benjamin/thesis/scripts/run_safetycar_minimal_human_ready_local.sh \
  ...
  INIT_CHECKPOINT_PATH="$SAFE_SEED_CKPT" \
