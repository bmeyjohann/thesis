...
export ALGO_VARIANT="${ALGO_VARIANT:-eil}"
...
export EIL_THRESHOLD="${EIL_THRESHOLD:-0.0}"
export EIL_GOOD_MARGIN="${EIL_GOOD_MARGIN:-0.0}"
export EIL_BAD_MARGIN="${EIL_BAD_MARGIN:-0.01}"
export EIL_PAIR_MARGIN="${EIL_PAIR_MARGIN:-0.01}"
export EIL_BAD_PRE_STEPS="${EIL_BAD_PRE_STEPS:-8}"
export NAME_SUFFIX="${NAME_SUFFIX:-eil}"
