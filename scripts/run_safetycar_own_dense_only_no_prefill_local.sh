...
WANDB_RUN_NAME="${WANDB_RUN_NAME:-safetycar_goal2_own_dense_only_no_prefill_${TS}}"
...
echo "Starting SafetyCar dense-only run without demo prefill."
echo "Online human intervention remains enabled."
