...
export RUN_TS="${RUN_TS:-$(date +%Y%m%d_%H%M%S)_clearance_or_progress_smallbc}"
...
# Diagnostic branch: keep preference loss primary, add a weak direct action target on intervened rows.
