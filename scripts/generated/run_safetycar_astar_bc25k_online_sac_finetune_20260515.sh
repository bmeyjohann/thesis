...
exec /home/benjamin/thesis/scripts/run_safetycar_minimal_human_ready_local.sh \
  EXP_NAME=safetycar_astar_bc25k_online_sac_finetune_20260515 \
  EXP_PREFIX=safetycar_astar_bc25k_online_sac_finetune \
  VARIANT=own \
  ...
  WANDB_GROUP=safetycar_curriculum_astar_online_finetune_20260515 \
  SEED=370 \
