...
CKPT="/home/benjamin/thesis/models/safetygym_knn_bc/safetycar_knn_bc_scriptedgeo_rich_throttle_aggregate100k_k3_20260516/policy.npz"
OUT_DIR="/home/benjamin/thesis/logs/safetygym_knn_bc/posthoc_audited/knn_bc_scriptedgeo_rich_throttle_aggregate100k_k3_seed424242_32ep_20260516"
for _ in $(seq 1 120); do
  if [[ -s "$CKPT" ]]; then break; fi
  echo "waiting for KNN checkpoint: $CKPT"
  sleep 5
done
if [[ ! -s "$CKPT" ]]; then
