...
BASE="$ROOT/models/unitree_mjlab_nav_thesis/unitree_student_scratch_dense_clear06_gatefix_10k_20260713"
CONT="$ROOT/models/unitree_mjlab_nav_thesis/unitree_student_scratch_dense_clear06_resume2500_warmup_to10k_20260713"
...
eval_checkpoint() {
  ...
  RUN_NAME="scratch_effective_step_${effective_step}" \
  OUTPUT_DIR="$OUT" \
  RECORD_VIDEO=0 \
  SEED=101 \
  NUM_ENVS=32 \
