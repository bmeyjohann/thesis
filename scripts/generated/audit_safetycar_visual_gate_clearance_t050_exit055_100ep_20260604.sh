...
OUT_DIR="${OUT_DIR:-/home/benjamin/thesis/logs/safetygym_eval_audits/visual_gate_clearance_t050_exit055_teacher_m030_e014_shield0_${EPISODES}ep_20260604}"
...
"${PYTHON}" /home/benjamin/thesis/eval_interactive_safetygym.py \
  ...
  --episode_plot_max_episodes "${PLOT_MAX}" \
