...
export OUT_DIR="${OUT_DIR:-$ROOT/logs/safetygym_eval_audits/visual_gate_clearance_projrelease_or_progress_t050_rel020_teacher_m036_e020_shield0_${EPISODES}ep_20260604}"
