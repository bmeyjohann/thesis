...
export TEACHER_OVERRIDE_CLEARANCE_EXIT_THRESHOLD="${TEACHER_OVERRIDE_CLEARANCE_EXIT_THRESHOLD:-0.55}"
...
export OUT_DIR="${OUT_DIR:-$ROOT/logs/safetygym_eval_audits/visual_gate_candidate_t050_exit055_teacher_m030_directional_e014_shield0_${EPISODES}ep_20260604}"
