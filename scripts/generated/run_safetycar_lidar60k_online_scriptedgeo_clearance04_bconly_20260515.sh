...
exec /home/benjamin/thesis/scripts/run_safetycar_minimal_human_ready_local.sh \
  EXP_NAME=safetycar_lidar60k_online_scriptedgeo_clearance04_bconly_20260515 \
  EXP_PREFIX=safetycar_lidar60k_online_scriptedgeo_clearance04_bconly \
  VARIANT=own \
  ...
  WANDB_GROUP=safetycar_curriculum_online_corrections_20260515 \
  SEED=884 \
  ...
  TEACHER_OVERRIDE_CLEARANCE_THRESHOLD=0.4 \
  TEACHER_OVERRIDE_CLEARANCE_EXIT_THRESHOLD=0.6 \
