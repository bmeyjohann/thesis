...
CONTROLLER=policy \
MODEL_PATH="$ROOT/models/unitree_mjlab_nav_thesis/unitree_teacher_distill_goalinit_bc5_5k_20260713/step_2500.pt" \
RUN_NAME=teacher_distill_goalinit_bc5_step_2500 \
