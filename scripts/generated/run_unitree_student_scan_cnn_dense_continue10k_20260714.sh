...
export RUN_NAME=unitree_student_scan_cnn_dense_geom_clear06_continue_from10k_20260714
export WANDB_MODE=online
export WANDB_PROJECT=thesis-unitree-nav
export WANDB_GROUP=unitree_scan_cnn_research_20260714
export SEED=31
export NUM_ENVS=8
...
export INIT_CHECKPOINT=/home/benjamin/thesis/models/unitree_mjlab_nav_thesis/unitree_student_scan_cnn_scratch_dense_geom_clear06_10k_20260714/step_10000.pt
