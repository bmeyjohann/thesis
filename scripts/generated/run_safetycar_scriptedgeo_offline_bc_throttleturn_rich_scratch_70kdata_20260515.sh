...
DATASET_PATH="/home/benjamin/thesis/data/safetygym_datasets/safetycar_goal1_scriptedgeo_randomblocked_rich_throttleturn_70k_20260515.npz"
...
exec /home/benjamin/thesis/scripts/run_safetycar_minimal_human_ready_local.sh \
  EXP_NAME=safetycar_offline_scriptedgeo_bc_throttleturn_rich_scratch_70kdata_20260515 \
  EXP_PREFIX=safetycar_offline_scriptedgeo_bc_throttleturn_rich_scratch_70kdata \
  VARIANT=own \
  ...
  WANDB_GROUP=safetycar_curriculum_throttleturn_rich_offlinebc_20260515 \
  SEED=916 \
  ...
  ACTOR_BC_ONLY_UNTIL_STEP=50000 \
