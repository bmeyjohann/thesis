...
export RUN_NAME=unitree_gated_direct_forced_margin05_audit_20260713
...
export INTERVENTION_CLEARANCE_THRESHOLD=0.65
export INTERVENTION_RELEASE_CLEARANCE=0.80
