...
exec /home/benjamin/thesis/scripts/run_safetycar_minimal_human_ready_local.sh \
  EXP_NAME=safetycar_lidar60k_bc15_scriptedgeo_studentfwd_clean_own_10k_20260515 \
  EXP_PREFIX=safetycar_lidar60k_bc15_scriptedgeo_studentfwd_own \
  VARIANT=own \
  ...
  DEMO_DATASET_CLEAR_TEACHER_FLAGS_IN_REPLAY=1 \
