...
exec /home/benjamin/thesis/scripts/run_safetycar_minimal_human_ready_local.sh \
  EXP_NAME=safetycar_lidar60k_mixedbc15_safety_termcost_finetune_15k_20260515 \
  EXP_PREFIX=safetycar_lidar60k_mixedbc15_safety_termcost_finetune \
  VARIANT=plain \
