...
METHOD="${1:?usage: $0 thesis|hilserl|eil|pvp|hg_dagger|sac [seed]}"
SEED="${2:-0}"
case "$METHOD" in
...
TAG="${COMPARISON_TAG:-20260718_v2}"
...
# Exact random multi-obstacle benchmark manifest.
...
printf '%s\n' \
  ...
  "eval cohort: seed=$EVAL_SEED episodes=$EVAL_NUM_EPISODES"
