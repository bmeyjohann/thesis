...
CONTROLLER=policy \
MODEL_PATH="$ROOT/models/unitree_mjlab_nav_thesis/unitree_student_scratch2500_strongbc1_to7500_20260713/step_5000.pt" \
RUN_NAME=scratch2500_strongbc1_effective_step_7500 \
