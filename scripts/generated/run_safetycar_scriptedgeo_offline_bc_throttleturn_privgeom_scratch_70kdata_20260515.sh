...
exec /home/benjamin/thesis/scripts/run_safetycar_minimal_human_ready_local.sh \
  EXP_NAME=safetycar_offline_scriptedgeo_bc_throttleturn_privgeom_scratch_70kdata_20260515 \
  EXP_PREFIX=safetycar_offline_scriptedgeo_bc_throttleturn_privgeom_scratch_70kdata \
  VARIANT=own \
  ...
  WANDB_GROUP=safetycar_curriculum_throttleturn_privgeom_offlinebc_20260515 \
  SEED=916 \
