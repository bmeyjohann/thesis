...
INIT_CKPT="/home/benjamin/thesis/models/safetygym_minimal/safetycar_offline_astar_bc_h256_b512_lidarbc_60kdata_20260515/step_35000.pt"
...
exec /home/benjamin/thesis/scripts/run_safetycar_minimal_human_ready_local.sh \
  EXP_NAME=safetycar_lidar35k_scriptedgeo_clearance_bconly_20260515 \
  EXP_PREFIX=safetycar_lidar35k_scriptedgeo_clearance_bconly \
  VARIANT=own \
  ...
  WANDB_GROUP=safetycar_curriculum_astar_online_corrections_20260515 \
  SEED=572 \
  ...
  TEACHER_OVERRIDE_CLEARANCE_EXIT_THRESHOLD=0.18 \
  ...
  EXPORT_REPLAY_DATASET_LABEL=safetycar_lidar35k_scriptedgeo_clearance_bconly
