...
exec /home/benjamin/thesis/scripts/run_safetygym_flow_matching_local.sh \
  EXP_NAME=safetycar_flow_scriptedgeo_privgeom_dataset_goal1_randomblocked_20260515 \
  EXP_PREFIX=safetycar_flow_scriptedgeo_privgeom_dataset_goal1_randomblocked \
  ENV_NAME=SafetyCarGoal1-v0 \
  WANDB_GROUP=safetycar_curriculum_flow_scriptedgeo_privgeom_dataset_20260515 \
  WANDB_MODE=online \
