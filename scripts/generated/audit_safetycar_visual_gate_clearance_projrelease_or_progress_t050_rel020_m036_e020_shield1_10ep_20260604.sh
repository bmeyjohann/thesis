...
export SCRIPTED_GEO_SAFETY_MARGIN="${SCRIPTED_GEO_SAFETY_MARGIN:-0.36}"
export SCRIPTED_GEO_EMERGENCY_CLEARANCE="${SCRIPTED_GEO_EMERGENCY_CLEARANCE:-0.20}"
export SCRIPTED_GEO_ACTION_SHIELD_STEPS="${SCRIPTED_GEO_ACTION_SHIELD_STEPS:-1}"
export OUT_DIR="${OUT_DIR:-$ROOT/logs/safetygym_eval_audits/visual_gate_clearance_projrelease_or_progress_t050_rel020_teacher_m036_e020_shield1_${EPISODES}ep_20260604}"
