...
export RUN_NAME=unitree_teacher_distill_bc20_resume2500_20260714
...
export GAMMA=0.99
export ALPHA_INIT=0.0001
export ALPHA_MIN=0.0001
export ALPHA_MAX=0.0001
export ACTOR_BC_WEIGHT=20.0
export PREF_RANK_WEIGHT=0.0
export PREF_RANK_MARGIN=0.05
export PREF_LOSS_TYPE=margin
export PREF_LAMBDA_LR=0.0
export PREF_LAMBDA_MAX=0.0
...
export INIT_CHECKPOINT=/home/benjamin/thesis/models/unitree_mjlab_nav_thesis/unitree_teacher_distill_goalinit_bc5_5k_20260713/step_2500.pt
