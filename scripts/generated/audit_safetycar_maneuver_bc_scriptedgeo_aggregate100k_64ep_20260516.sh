...
CKPT="/home/benjamin/thesis/models/safetygym_maneuver_bc/safetycar_maneuver_bc_scriptedgeo_rich_throttle_aggregate100k_20260516/best.pt"
OUT_DIR="/home/benjamin/thesis/logs/safetygym_maneuver_bc/posthoc_audited/maneuver_bc_scriptedgeo_rich_throttle_aggregate100k_seed424242_64ep_20260516"
for _ in $(seq 1 720); do
  if [[ -s "$CKPT" ]]; then break; fi
  echo "waiting for maneuver BC checkpoint: $CKPT"
  sleep 5
done
if [[ ! -s "$CKPT" ]]; then
