#!/usr/bin/env python3
"""Maze-focused HG-DAgger entrypoint."""
...
from ogbench_utils.hgdagger_ogbench_maze_cli import parse_hgdagger_maze_args
...
def main() -> None:
    args = parse_hgdagger_maze_args()
    _configure_mujoco_gl_for_train()
    import ogbench  # noqa: F401  # Registers environments.
    from ogbench_utils.hgdagger_ogbench_maze_train import run_hgdagger_ogbench_maze

    run_hgdagger_ogbench_maze(args, generate_policy_map=generate_policy_map)
