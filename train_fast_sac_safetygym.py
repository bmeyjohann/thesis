...
def build_parser() -> argparse.ArgumentParser:
    ...
    p.add_argument("--critic_loss_reduction", type=str, default="mean", choices=["sum", "mean"])
    ...
    p.add_argument("--reseed_on_episode_reset", dest="reseed_on_episode_reset", action="store_true")
    ...
    p.set_defaults(reseed_on_episode_reset=True)
    return p
